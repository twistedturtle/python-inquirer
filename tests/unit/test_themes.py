...
def test_themes_green_passion():
    ...
    assert hasattr(t.Question, "prefix")
    assert hasattr(t.Question, "int_msg")
    ...
    assert hasattr(t.options, "hsort")
    assert hasattr(t.options, "pad_size")
    assert hasattr(t.options, "arrangement")


def test_themes_green_star():
    t = themes.GreenStar()
...
def test_themes_green_asterisk():
    t = themes.GreenAsterisk()
